        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="vida-card">
            <div className="flex items-start gap-3 mb-4">
              <MapPin className="w-6 h-6 text-[#1FBD8F] flex-shrink-0 mt-1" />
              <h3 className="text-2xl font-bold font-poppins text-[#1FBD8F]">
                Tupanciretã
              </h3>
            </div>
          ...
          {/* Insight Card */}
          <div className="bg-gradient-to-br from-[#1FBD8F] to-[#17A577] rounded-lg p-8 text-white">
