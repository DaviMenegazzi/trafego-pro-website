...
_Relatório de performance gerado pela Tráfego Pro._`;
  ...
  return (
    <div 
      role="dialog"
      aria-modal="true"
      aria-label="Imagem do relatório para WhatsApp"
    ...
    >
      ...
      >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm font-bold text-white flex items-center gap-2">
                Imagem do relatório para WhatsApp
                
              </h2>
              <p className="text-xs text-zinc-400">
                Pré-visualize, copie ou baixe o resumo executivo da unidade.
              </p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 min-h-0 overflow-y-auto p-5 sm:p-8 bg-zinc-950/90 flex flex-col items-center">
          ...
          <div
            ref={cardRef}
            className="w-full max-w-[880px] rounded-3xl border border-white/15 bg-gradient-to-b from-zinc-900 via-zinc-950 to-zinc-950 p-6 sm:p-8 shadow-2xl text-white space-y-6 relative overflow-hidden box-border my-1"
