...
const TABLES = [
  ...
  { name: "external_ai_api_tokens", columns: ["id", "owner_user_id", "name", "token_prefix", "token_hash", "scopes_json", "unit_ids_json", "expires_at", "revoked_at", "last_used_at", "rate_window_started_at", "rate_window_count", "created_at"], transform: { scopes_json: json, unit_ids_json: json } },
